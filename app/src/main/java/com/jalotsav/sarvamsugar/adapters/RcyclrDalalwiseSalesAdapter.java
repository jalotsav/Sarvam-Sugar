...
public class RcyclrDalalwiseSalesAdapter extends RecyclerView.Adapter<RcyclrDalalwiseSalesAdapter.ViewHolder>  {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        MdlDalalwsSlsData objMdlGodownStckData = mArrylstDalalwsSlsData.get(position);
        holder.tvFirstChar.setText(objMdlGodownStckData.getDalal().substring(0,1));
        holder.tvDalalName.setText(mContext.getResources().getString(R.string.partyname_bracket_pcode, objMdlGodownStckData.getDalal(), objMdlGodownStckData.getDpCode()));
        holder.tvMadhur.setText(objMdlGodownStckData.getMadhur());
        holder.tvOther.setText(objMdlGodownStckData.getOther());
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView tvFirstChar, tvDalalName, tvMadhur, tvOther;
